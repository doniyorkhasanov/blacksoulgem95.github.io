...
@section('body')
    ...
    <p class="mb-6 flex justify-around"><a target="_blank" href="//go.italianprogrammer.pizza/linkedin" class="btn btn-blue">Check out my LinkedIn</a> <a target="_blank" href="//go.italianprogrammer.pizza/cv" class="btn btn-blue">Check out my Resume</a> </p>
