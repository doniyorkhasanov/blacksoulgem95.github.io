...
<head>
    ...
    @include('_components.cookie-banner')
</head>
    ...
    <div class="container flex items-center max-w-8xl mx-auto px-4 lg:px-8">
        <div class="flex items-center">
            <a href="/" title="{{ $page->siteName }} home" class="inline-flex items-center">
                ...
                {{--                        <h1 class="text-lg md:text-2xl text-pink-800 font-semibold hover:text-pink-600 my-0">{{ $page->siteName }}</h1>--}}
            </a>
        </div>
...
<footer class="bg-white text-center text-sm mt-12 py-4" role="contentinfo">
    <ul class="flex flex-col md:flex-row justify-around list-none">
        ...
        <li>
            @include("_components.random-quote")
        </li>
        ...
        <li>
            @foreach($socials as $social)
                ...
                <a href="{{$social->url}}" target="_blank"
                   class=" @if(!$loop->last) mr-3 @endif text-2xl md:text-base ">
